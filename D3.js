...
while (i < starWarsCharacters.length) {
  crewMass += starWarsCharacters[i].mass || 0; // Aggiunge la massa del personaggio corrente alla massa totale dell'equipaggio
  i++; // Incrementa l'indice per passare al personaggio successivo
}
...
// Supponiamo che la variabile crewMass contenga la massa totale dell'equipaggio
